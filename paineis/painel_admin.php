			...
			<div class="collapse navbar-collapse" id="navbarResponsive">
				...
				<ul class="navbar-nav ml-auto nav-flex-icons">
					...
					<li class="nav-item dropdown mr-3">
						<a class="nav-link dropdown-toggle" id="navbarDropdownPainel-admin" data-toggle="dropdown" aria-haspopup="true" aria-expanded="false">
							<i class="fas fa-user"></i>
						</a>
						<div class="dropdown-menu dropdown-menu-right dropdown-default" aria-labelledby="navbarDropdownPainel-admin">
					...
					<li class="nav-item avatar mt-1 mr-1">
						<a class="nav-link p-0" href="#">
							<img src="https://mdbootstrap.com/img/Photos/Avatars/avatar-13.jpg" class="rounded-circle z-depth-0" alt="avatar image" height="35">
						</a>

					</li>
					<li class="nav-item avatar mt-2">
						<span class="text-muted nome_usuario">Felipe Costa </span>
			...
			<div class="col-lg-2 col-md-3 col-sm-12">
				...
				<div class="bg-light" id="sidebar-wrapper">
					...
					<div class="list-group list-group-flush">
						...
						<a href="#" class="list-group-item list-group-item-action bg-light"><i class="fas fa-rocket mr-1"></i>Desempenho</a>
