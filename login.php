    ...
    <div class="justify-content-center d-flex h-100">
      <div class="card_login">
        ...
        <div class="d-flex justify-content-center mt-3 area_botao">
          <button type="button" name="button" class="btn btn_login">Login</button>
        </div>
        <div class="mt-4 area_links">
          <div class="d-flex justify-content-center links"> Não possui cadastro? <a href="#" class="ml-2">Cadatre-se</a>
          </div>
